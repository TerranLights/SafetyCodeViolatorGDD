...
## Engine Version
**Godot 4.7 (stable)** — Excellent 2D performance, strong mobile support, and great GDExtension/C++ options if needed. Single codebase exports to Windows, Linux (including Steam Deck native), and Android.
